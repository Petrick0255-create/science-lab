...
물리학, 화학, 생명과학, 지구과학, 통합과학 문항 9,072개를 발문·보기·선지·유형·해설의 키워드로 검색하는 정적 웹앱입니다.
...
화면의 `로컬 파일 우선`을 켜면 아래 상대 경로를 사용합니다. 이 앱 폴더의 `data` 아래에 기존 자료 폴더를 그대로 두면 됩니다.
...
- 문제 PDF와 해설 PDF 바로가기
- Drive/로컬 파일 우선 모드 전환 및 이미지 자동 대체
