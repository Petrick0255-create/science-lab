 ...
 * 다시 정리한 메이킹용 세부 유형입니다. 한 유형당 25개입니다.
 */
const EVIDENCE_DETAIL_TYPES = {
  "과학의 기본량": [
    "기본량과 유도량", "길이", "질량", "시간", "전류",
    "온도", "물질량", "광도", "국제단위계", "자연 세계의 규모",
    "기본량의 분류", "유도량의 계산", "단위 변환", "단위 기호", "크기의 차수",
    "미시 세계의 규모", "거시 세계의 규모", "넓이와 부피", "속력과 밀도", "측정값의 비교",
    "일상생활 속 기본량", "물리량과 단위 연결", "자료에서 기본량 찾기", "제품 정보의 물리량", "기본량 7가지",
  ],
  "측정 표준과 정보": [
    "측정 표준", "길이 측정", "시간 측정", "측정과 어림", "센서와 신호",
    "아날로그 신호", "디지털 신호", "신호의 변환", "디지털 정보", "측정 표준의 유용성",
    "국제 측정 표준", "빛의 속력과 길이 표준", "원자시계와 시간 표준", "큰 길이의 측정", "작은 길이의 측정",
    "측정 도구의 선택", "측정값의 정밀도", "센서의 원리", "센서의 종류", "자연의 신호",
    "아날로그·디지털 신호 비교", "표본화와 디지털 변환", "이진 정보", "정보의 저장과 전송", "센서 데이터 처리",
  ],
  "우주의 시작과 원소의 생성": [
    "스펙트럼", "빅뱅 우주론", "우주 초기의 진화", "기본 입자의 생성", "수소·헬륨 원자핵 생성",
    "원자의 생성", "우주 배경 복사", "우주 초기 원소", "우주의 구성 원소", "스펙트럼을 통한 원소 확인",
    "연속 스펙트럼", "흡수 스펙트럼", "방출 스펙트럼", "양성자·중성자·전자", "우주 온도와 밀도 변화",
    "우주 팽창", "우주 초기 사건의 순서", "헬륨 원자핵 생성", "수소와 헬륨의 질량비", "재결합 시기",
    "빅뱅 핵합성", "빅뱅 우주론의 증거", "정상 우주론과 비교", "별빛의 스펙트럼", "원소별 스펙트럼",
  ],
  "지구와 생명체를 구성하는 원소의 생성": [
    "별의 진화", "별의 질량과 진화 경로", "별 내부의 핵융합", "별 내부 구조", "무거운 원소의 생성",
    "초신성 폭발", "성운의 형성", "태양계 형성", "지구 형성", "원소의 순환",
    "별의 탄생", "주계열성", "적색 거성", "초거성", "백색 왜성",
    "중성자별과 블랙홀", "수소 핵융합", "헬륨 핵융합", "철까지의 원소 생성", "철보다 무거운 원소 생성",
    "별 질량에 따른 최후", "성간 물질", "원시 태양", "미행성의 충돌", "태양계와 지구의 구성 원소",
  ],
  "원소의 규칙성": [
    "금속과 비금속", "알칼리 금속", "주기율표", "할로젠", "원소의 주기성",
    "원자가 전자", "족에 따른 성질", "원자 구조", "이온 형성", "원소 분류",
    "알칼리 금속과 물의 반응", "알칼리 금속의 반응성", "할로젠의 반응성", "같은 족 원소의 성질", "주기에 따른 성질",
    "금속 원소의 성질", "비금속 원소의 성질", "전자껍질", "전자 배치", "양이온 형성",
    "음이온 형성", "안정한 전자 배치", "원소의 위치 추론", "성질로 원소 찾기", "주기율표 자료 해석",
  ],
  "화학 결합과 물질의 성질": [
  ...
  "지구 시스템의 구성과 상호 작용": [
    ...
    "기권", "수권", "지권", "생물권", "외권",
    "상호 작용 분류", "탄소의 분포", "물질 순환", "태양 에너지", "지구 내부 에너지",
    "해수의 연직 수온 분포", "우리나라 주변 해류", "육지의 물 분포", "물의 순환과 지형 변화", "지구 시스템과 생명체",
  ],
  "지권의 변화와 영향": [
  ...
  "전기 에너지의 생산": [
    ...
    "코일과 자석의 상대 운동", "자석의 극과 유도 전류", "자석의 속력과 유도 전류", "코일 감은 수와 유도 전류", "검류계 방향",
    "발전기 회전 방향", "발전 전류", "전자기 유도 실험", "역학적 에너지의 전환", "전기 에너지의 전환",
    "화력·핵발전 공통점", "화력·핵발전 차이", "발전 방식 비교", "발전의 환경 영향", "신재생 발전",
  ],
  "에너지 효율과 신재생 에너지": [
